...
public class RoadFootpath extends AppCompatActivity {
    EditText title, description, address;
    String s1, s2, s3, s4, s5, s6, s7, s8, s9, s10;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_road_footpath);
        findviews();
    ...
    private void getData() {
        ...
        s10 = "Road and Foothpath maintainance";
    }
...
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(RoadFootpath.this, "Submit data successfully...", Toast.LENGTH_SHORT).show();
                        new AlertDialog.Builder(RoadFootpath.this)
...
//                        animationDrawable.stop();
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(RoadFootpath.this, "Something went wrong in submitting...", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(RoadFootpath.this, "failure", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
