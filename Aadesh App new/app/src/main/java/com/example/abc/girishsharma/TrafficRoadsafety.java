...
public class TrafficRoadsafety extends AppCompatActivity {
    EditText title, description, address;
    String s1, s2, s3, s4, s5, s6, s7, s8, s9, s10;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_traffic_roadsafety);
        findviews();
...
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(TrafficRoadsafety.this, "Submit data successfully...", Toast.LENGTH_SHORT).show();
                        new AlertDialog.Builder(TrafficRoadsafety.this)
...
//                        animationDrawable.stop();
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(TrafficRoadsafety.this, "Something went wrong in submitting...", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(TrafficRoadsafety.this, "failure", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
