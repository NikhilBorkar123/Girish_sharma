...
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(Pollution.this, "Submit data successfully...", Toast.LENGTH_SHORT).show();
                        new AlertDialog.Builder(Pollution.this)
...
//                        animationDrawable.stop();
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(Pollution.this, "Something went wrong in submitting...", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(Pollution.this, "failure", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
