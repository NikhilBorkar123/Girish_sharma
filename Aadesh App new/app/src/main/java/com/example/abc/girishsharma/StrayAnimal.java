...
public class StrayAnimal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stray_animal);
        findviews();
...
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(StrayAnimal.this, "Submit data successfully...", Toast.LENGTH_SHORT).show();
                        new AlertDialog.Builder(StrayAnimal.this)
...
//                        animationDrawable.stop();
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(StrayAnimal.this, "Something went wrong in submitting...", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(StrayAnimal.this, "failure", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
