...
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(PublicTransport.this, "Submit data successfully...", Toast.LENGTH_SHORT).show();
                        new AlertDialog.Builder(PublicTransport.this)
...
//                        animationDrawable.stop();
//                        loading.setVisibility(View.INVISIBLE);
                        Toast.makeText(PublicTransport.this, "Something went wrong in submitting...", Toast.LENGTH_SHORT).show();
                    }
                } else {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(PublicTransport.this, "failure", Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
